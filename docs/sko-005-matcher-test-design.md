...
: Executes the synthetic legal-form fixture catalogue against `classify_name_candidates()`.
...
Existing matcher modules continue to test canonical safe-list behaviour, legacy trusted-entity behaviour, country boundaries and end-to-end matcher output.
...
4. the canonical `test_matcher*.py` command catches the matcher regression suite including legal-form fixtures;
